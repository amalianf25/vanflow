...
<header class="flex items-center justify-between bg-white px-8 py-5
    ...
    <div class="flex items-center gap-2">
        <span class="text-gray-700 text-sm font-medium">Andi</span>
        <a href="#" class="flex items-center justify-center p-1.5 rounded-full hover:bg-blue-50 transition duration-150"
           title="Lihat Profil">
                ...
                <tbody>
                    @foreach ($laporan as $data)
                        <tr class="hover:bg-blue-50 transition">
                            <td class="py-3 px-4 border border-gray-300 text-gray-700">{{ $data['nama_pembeli'] }}</td>
                            <td class="py-3 px-4 border border-gray-300 text-gray-700">{{ $data['jumlah_pembelian'] }}</td>
                            <td class="py-3 px-4 border border-gray-300 text-gray-700">{{ $data['keterangan'] }}</td>
                            <td class="py-3 px-4 border border-gray-300 text-gray-700">{{ $data['status'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
